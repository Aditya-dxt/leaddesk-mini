    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main className="max-w-7xl mx-auto px-6 py-8">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
          ...
          <div className="relative w-full md:w-80">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2 bg-muted border border-muted-foreground/20 rounded-lg focus:outline-none focus:border-accent text-sm"
            />
          </div>
        </div>
        ...
        {loading ? (
          ...
          <div className="text-center py-24 bg-muted/30 rounded-xl border border-muted-foreground/10 border-dashed">
          ...
          <div className="overflow-x-auto rounded-xl border border-muted-foreground/20 bg-muted/30">
                  ...
                  <tr key={lead.id} className="hover:bg-muted/50 transition-colors">
                    ...
                    <td className="px-6 py-4">
                      <select
                        ...
                        className={`text-xs font-medium px-2.5 py-1 rounded-full border appearance-none cursor-pointer focus:outline-none ${getStatusBadgeClass(lead.status)}`}
                      >
